...
\begin{itemize}
  ...
  \item An adversary selects weights $w_t:E\to\RR_{\geq0}$
    and $b_t:V\to\RR_{\geq0}$
    satisfying the remaining constraints
    that maximizes some objective function
    (for our purposes, we can think of this objective function as approximating the
    original inner objective function).
